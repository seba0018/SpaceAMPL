...
#Quadrotor params
    ...
    param omega_max default    11100;   # [rpm] Max min per rotor
...
#Other
    ...
    #param v_finaln default 4.0;            # [m/s] Guess for final velocity
#-------------------------------------------------------------
...
#Constraints------------------------------------------
    ...
    subject to FinalVelocityz : -vx[n]*sin(theta[n]) + vy[n]*sin(phi[n])*cos(theta[n]) + vz[n]*cos(phi[n])*cos(theta[n]) = 0;
